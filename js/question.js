let main_questions = document.querySelector('.main_questions');

fetch('https://blog.albayanres.com/api/questions').then(
    res => res.json()
).then(
    res => res.forEach((e,index) => {
        main_questions.innerHTML += `
            <div class="questions-container">
                <p class="question active flex question_${index}">
                    ${e.name}
