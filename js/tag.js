...
fetch('https://blog.albayanres.com/api/tag_blog', {

    method: 'POST',
    body: JSON.stringify({
        name: localStorage.getItem('tag'),
        ...
        if (e.blog != null) {
            ...
            main_blog.innerHTML += `
                <div class="blog-p" style='height:fit-content;'>
                    <a href="read.html?blog_details=${e.blog.id}" class="img">
                        <img src="https://blog.albayanres.com/images_blog/${e.blog.image}" alt="">
                    </a>
                    <!-- blog-name -->
                    ...
                    <div class="date-views flex">
                        <p class="date">
                            ...
                            <span>
                                ${e.blog.created_at.slice(0, 10)}
                            </span>
                        </p>
                        <p class="views">
                            <i class="fa-solid fa-eye"></i>
                            <span>${e.blog.views}</span>
                        </p>
                    </div>
                    <!-- Categories -->
                    ...
                    <!-- description -->
                    <a href="read.html?blog_details=${e.blog.id}" class="description">
                       ${e.blog.sub_text}
                    </a>
                </div>
                </div>
